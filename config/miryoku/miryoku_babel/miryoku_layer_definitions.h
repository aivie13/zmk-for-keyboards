...
U_MT_LEFT(LCTRL, A), U_MT_LEFT(LALT, S), U_MT_LEFT(LGUI, D), U_MT_LEFT(LSHFT, F), &kp G,         &kp H,             U_MT_RIGHT(LSHFT, J), U_MT_RIGHT(LGUI, K), U_MT_RIGHT(LALT, L), U_MT_RIGHT(LCTRL, SEMI), \
...
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              &bt BT_CLR_ALL,    &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
