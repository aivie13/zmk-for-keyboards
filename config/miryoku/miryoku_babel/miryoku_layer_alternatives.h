...
U_MT_LEFT(LGUI, A), U_MT_LEFT(LALT, R), U_MT_LEFT(LCTRL, S), U_MT_LEFT(LSHFT, T), &kp D,         &kp H,             U_MT_RIGHT(LSHFT, N), U_MT_RIGHT(LCTRL, E), U_MT_RIGHT(LALT, I), U_MT_RIGHT(LGUI, O), \
...
U_MT_LEFT(LCTRL, A), U_MT_LEFT(LALT, R), U_MT_LEFT(LGUI, S), U_MT_LEFT(LSHFT, T), &kp G,         &kp M,             U_MT_RIGHT(LSHFT, N), U_MT_RIGHT(LGUI, E), U_MT_RIGHT(LALT, I), U_MT_RIGHT(LCTRL, O), \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_SYM, RET),  U_LT(U_NUM, BSPC), U_LT(U_FUN, DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MT_LEFT(LGUI, A), U_MT_LEFT(LALT, R), U_MT_LEFT(LCTRL, S), U_MT_LEFT(LSHFT, T), &kp G,         &kp K,             U_MT_RIGHT(LSHFT, N), U_MT_RIGHT(LCTRL, E), U_MT_RIGHT(LALT, I), U_MT_RIGHT(LGUI, O), \
